...
func vmClusterComplete(t *testing.T, f *framework.Framework, ctx *framework.Context) error {
					...
					VolumeClaimTemplate: operator.EmbeddedPersistentVolumeClaim{
						Spec: v1.PersistentVolumeClaimSpec{
							Resources: v1.ResourceRequirements{
								Requests: v1.ResourceList{"storage": func()resource.Quantity{ q := resource.NewQuantity(1000000000,resource.DecimalSI); return *q}() },
							},
						},
					},
				},
	...
	err =  WaitForSts (t, f.KubeClient, namespace, "vmselect-example-vmcluster", 2, retryInterval, timeout)
	if err != nil {
		return err
	}
	...
	exampleVmCluster.Spec.VMStorage.ReplicaCount = pointer.Int32Ptr(3)
	exampleVmCluster.Spec.VMSelect.ReplicaCount = pointer.Int32Ptr(4)
	...
	err =  WaitForSts (t, f.KubeClient, namespace, "vmstorage-example-vmcluster", 3, retryInterval, timeout)
	if err != nil {
		return err
	}
	err =  WaitForSts (t, f.KubeClient, namespace, "vmselect-example-vmcluster", 4, retryInterval, timeout)
	if err != nil {
		return err
	}
